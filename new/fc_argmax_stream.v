...
module fc_argmax_stream #(
    ...
    parameter integer IN_CH            = 64,
    parameter integer OUT_CLASS        = 12,
    parameter integer WEIGHT_W         = 8,
    parameter integer BIAS_W           = 32,
    parameter integer ACC_W            = 40,
    parameter integer Q_MUL            = 239,
    parameter integer Q_SHIFT          = 16,
    parameter integer Q_OFFSET         = 128,
    parameter         WEIGHT_INIT_FILE = "fc_weight.memh",
    parameter         BIAS_INIT_FILE   = "fc_bias.memh"
)(
    input  wire                  clk,
    input  wire                  rst_n,
    input  wire                  in_valid,
    ...
    function [ACC_W-1:0] quantize_acc;
        ...
        begin
            ...
            quantize_acc = quant_signed + Q_OFFSET;
        end
    endfunction
